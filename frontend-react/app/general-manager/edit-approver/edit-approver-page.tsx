    ...
    const fetchUser = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          userRole: user.userRole || user.role || "CONTENT_APPROVER",
        })
      } catch (err) {
    ...
    if (validateForm()) {
      try {
        ...
        await axios.put(`${API_BASE_URL}/api/v1/admin/users/${userId}`, {
          ...
          userRole: formData.userRole || "CONTENT_APPROVER",
        }, {
          headers: { Authorization: `Bearer ${token}` }
        })
        setShowSuccess(true)
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-600">Cập nhật thông tin người duyệt</p>
                </div>
              </div>
            </div>
            {/* Main Form */}
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
            ...
            <div className="font-semibold mb-2">Cập nhật người duyệt thành công!</div>

    ...
    const fetchUser = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          userRole: user.userRole || user.role || "LEARNER",
        })
      } catch (err) {
    ...
    if (validateForm()) {
      try {
        ...
        await axios.put(`${API_BASE_URL}/api/v1/admin/users/${userId}`, {
          ...
          userRole: formData.userRole || "LEARNER",
        }, {
          headers: { Authorization: `Bearer ${token}` }
        })
        setShowSuccess(true)
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base text-blue-600">Cập nhật thông tin học viên</p>
                </div>
              </div>
            </div>
            {/* Main Form */}
      ...
      {showSuccess && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-6 max-w-sm w-full text-center">
            ...
            <div className="font-semibold mb-2">Cập nhật học viên thành công!</div>
